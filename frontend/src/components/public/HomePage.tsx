            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-3.5">
                ...
                <a
                  ...
                  className="px-6 py-3 rounded-2xl bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-black shadow-xl shadow-emerald-600/40 transition-all flex items-center gap-2 active:scale-95 border border-white/20"
                >
                  ...
                  <span>WhatsApp (+91 8005072171)</span>
                </a>
