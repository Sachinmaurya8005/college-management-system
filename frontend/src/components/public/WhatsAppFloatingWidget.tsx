  ...
  return (
    <div className={`relative flex flex-col items-end ${className}`}>
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center cursor-pointer border-2 border-white/20 group animate-whatsapp-blink"
      >
