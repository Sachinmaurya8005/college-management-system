...
export const INITIAL_APPROVAL_REQUESTS: StaffApprovalRequest[] = [
  {
    ...
    payload: {
      ...
      email: 'aman.cse22@gpbansdih.ac.in',
      fee_status: 'Pending'
    },
    status: 'Pending',
    admin_remarks: '',
  ...
  },
  {
    ...
    submitted_by_email: 'pratibha.it@gpbansdih.ac.in',
  ...
  },
  {
    ...
    submitted_by_email: 'vinay.me@gpbansdih.ac.in',
    ...
    payload: {
      ...
      email: 'suresh.me22@gpbansdih.ac.in',
      fee_status: 'Paid'
    },
    status: 'Pending',
    admin_remarks: '',
        ...
        try {
          ...
          if (!exists) {
            studentList.unshift({
              ...
              email: target.payload.email || `${target.roll_number.toLowerCase()}@gpbansdih.ac.in`,
