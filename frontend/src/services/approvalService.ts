...
export const INITIAL_APPROVAL_REQUESTS: StaffApprovalRequest[] = [
  {
    ...
    payload: {
      ...
      email: 'aman.cse22@Government Polytechnic.ac.in',
      fee_status: 'Pending'
    },
    status: 'Pending',
    admin_remarks: '',
  ...
  },
  {
    ...
    submitted_by_email: 'pratibha.it@Government Polytechnic.ac.in',
  ...
  },
  {
    ...
    submitted_by_email: 'vinay.me@Government Polytechnic.ac.in',
    ...
    payload: {
      ...
      email: 'suresh.me22@Government Polytechnic.ac.in',
      fee_status: 'Paid'
    },
    status: 'Pending',
    admin_remarks: '',
        ...
        try {
          ...
          if (!exists) {
            studentList.unshift({
              ...
              email: target.payload.email || `${target.roll_number.toLowerCase()}@Government Polytechnic.ac.in`,
              address: target.payload.address || 'Uttar Pradesh, UP',
